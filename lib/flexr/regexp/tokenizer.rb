...
# spec-digest: sha256:dfe81e0925a7f18432c25c2587ae17cebb3f5f00b70013be64c7ae433af23ce4
# artifact-schema: 1
# runtime-abi: 1
# unicode: 15.1.0
# backend: table
        ...
        loop do
          ...
          length = begin
            if %i[strscan auto].include?(mode) && defined?(::StringScanner)
              ...
              match = regexp.match(segment.byteslice(segment_position..).to_s, 0)
              match && match.begin(0).zero? ? match[0].bytesize : nil
            end
